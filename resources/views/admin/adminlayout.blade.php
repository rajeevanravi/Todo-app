...
@section('content')
    <nav id="xx" class="navbar fixed-top navbar-expand-lg bg-body-tertiary"
        ...
        <div class=" ">
            ...
            <a href="{{ route('adminviewtodo') }}"><button id="viewtodo" class="btn btn-outline-success me-2"
                    type="button">View Todo</button></a>
            <a href="{{ route('viewuser') }}"><button id="viewuser" class="btn btn-outline-success me-2"
                    type="button">View User</button></a>
