...
<nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary" style="width: fit-content; margin: 0 auto; padding: 10px 20px; border-radius: 8px;">
  <div class=" "  >
    <a href="{{route("adminaddtodo")}}"><button class="btn btn-outline-success me-2" type="button">Add Todo</button></a>
    <a href="{{route("adminviewtodo")}}"><button class="btn btn-outline-success me-2" type="button">View Todo</button></a>
